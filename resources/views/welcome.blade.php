...
@section('content')
    ...
    <header id="head">
        <div class="container">
            <div class="row">
                <h1 class="lead">  Buscador Semantico  </h1>
                <!--<p class="tagline">  Tu plataforma de creación de ebooks online  </p> -->
                @if (Auth::guest())
                    <p><a class="btn btn-default btn-lg" role="button" href="#conocemas">Conoce Mas</a> <a class="btn btn-action btn-lg" role="button" href="{{ url('/login') }}">Ingresa Ahora!</a></p>
                @else
    ...
    <div class="container text-center">
        ...
        <p class="text-muted">
            Comienza con nuestra plataforma y ten todas las herramientas que necesitas para publicar, subir textos o acceder a conocimiento mediante nuestro buscador. Todo desde la web!
        </p>
    </div>
    <!-- /Intro-->
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <a href="{{ url('/login') }}" class="btn btn-default btn-xl sr-button">Registrarse!</a>
            </div>
        </div>
    </aside>
