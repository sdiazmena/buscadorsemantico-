...
<header id="head" class="secondary"></header>
  ...
  <a class="btn btn-action btn-lg" role="button" href="<?php echo e(url('/users/ebooks/create')); ?>"><i class="fa fa-file-text" aria-hidden="true"> Crear Nuevo Texto</i></a>

            </div>
           <div class="container" style="margin-top: 60px;">

  <a class="btn btn-action btn-lg" role="button" href="<?php echo e(url('/storage/show')); ?>"><i class="fa fa-file-text" aria-hidden="true"> Subir Nuevo Texto</i></a>
