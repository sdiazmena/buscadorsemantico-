            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php if(Auth::guest()): ?>
                        ...
                        <li><a class="btn" href="<?php echo e(url('/login')); ?>">Registrarse / Ingresar</a></li>
                    <?php else: ?>
                ...
                <?php echo Form::open(['route' => 'users.categorias.store', 'method' => 'POST', 'class' => 'navbar-form navbar-left pull-right', 'role' => 'search']); ?>

                  <div class="form-group">
                    <?php echo Form::text('buscar', null, ['class' => 'form-control', 'placeholder' => 'Buscar']); ?>
